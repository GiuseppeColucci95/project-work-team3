        ...
        <div className="container py-5">
            ...
            <div className="faqs-content">
                ...
                <section className="mb-4">
                    ...
                    <p>Once your order is shipped, you will receive a tracking number via email. You can use this number to track your order on our <a href="/order-tracking" style={{ color: "#678b27" }}>Order Tracking</a> page.</p>
                </section>
